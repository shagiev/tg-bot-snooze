CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_user` (
...
CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_chat` (
...
CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_user_chat` (
  `user_id` bigint COMMENT 'Unique user identifier',
  `chat_id` bigint COMMENT 'Unique user or chat identifier',

  PRIMARY KEY (`user_id`, `chat_id`),

  FOREIGN KEY (`user_id`) REFERENCES `tg_snooze_it_bot_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (`chat_id`) REFERENCES `tg_snooze_it_bot_chat` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_inline_query` (
  ...
  FOREIGN KEY (`user_id`) REFERENCES `tg_snooze_it_bot_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_chosen_inline_result` (
...
CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_message` (
  ...
  FOREIGN KEY (`user_id`) REFERENCES `tg_snooze_it_bot_user` (`id`),
  FOREIGN KEY (`chat_id`) REFERENCES `tg_snooze_it_bot_chat` (`id`),
  FOREIGN KEY (`forward_from`) REFERENCES `tg_snooze_it_bot_user` (`id`),
  FOREIGN KEY (`forward_from_chat`) REFERENCES `tg_snooze_it_bot_chat` (`id`),
  FOREIGN KEY (`reply_to_chat`, `reply_to_message`) REFERENCES `tg_snooze_it_bot_message` (`chat_id`, `id`),
  FOREIGN KEY (`forward_from`) REFERENCES `tg_snooze_it_bot_user` (`id`),
  FOREIGN KEY (`left_chat_member`) REFERENCES `tg_snooze_it_bot_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_callback_query` (
  `id` bigint UNSIGNED COMMENT 'Unique identifier for this query',
  `user_id` bigint NULL COMMENT 'Unique user identifier',
  ...
  FOREIGN KEY (`user_id`) REFERENCES `tg_snooze_it_bot_user` (`id`),
  FOREIGN KEY (`chat_id`, `message_id`) REFERENCES `tg_snooze_it_bot_message` (`chat_id`, `id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_edited_message` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
  `chat_id` bigint COMMENT 'Unique chat identifier',
  `message_id` bigint UNSIGNED COMMENT 'Unique message identifier',
  `user_id` bigint NULL COMMENT 'Unique user identifier',
...
CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_telegram_update` (
  ...
  FOREIGN KEY (`chat_id`, `message_id`) REFERENCES `tg_snooze_it_bot_message` (`chat_id`, `id`),
  FOREIGN KEY (`inline_query_id`) REFERENCES `tg_snooze_it_bot_inline_query` (`id`),
  FOREIGN KEY (`chosen_inline_result_id`) REFERENCES `tg_snooze_it_bot_chosen_inline_result` (`id`),
  FOREIGN KEY (`callback_query_id`) REFERENCES `tg_snooze_it_bot_callback_query` (`id`),
  FOREIGN KEY (`edited_message_id`) REFERENCES `tg_snooze_it_bot_edited_message` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_520_ci;

CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_conversation` (
...
CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_botan_shortener` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
  `user_id` bigint NULL DEFAULT NULL COMMENT 'Unique user identifier',
...
CREATE TABLE IF NOT EXISTS `tg_snooze_it_bot_request_limiter` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
